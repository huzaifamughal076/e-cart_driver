import 'package:ecart_driver/screens/delivery_map_screen.dart';
  ...
  Container _buildBottom() {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          helpingMethods.openScreen(context: context, screen: const DeliveryMapScreen());
        },
        child: const Text(
  ...
  Widget orderListView() {
    return ListView.separated(
      ...
      itemBuilder: (BuildContext context, int index) => GestureDetector(
          ...
          child: orderItem(index, selectedIndex: selectedIndex)),
    );
  }
}
