...
import 'package:ecart_driver/widgets/loading_dialog.dart';
...
class SignUpScreen extends StatelessWidget {
  ...
  FocusNode registrationNode = FocusNode();
  FocusNode licenseNode = FocusNode();
  FocusNode nationalNode = FocusNode();
  FocusNode passportNode = FocusNode();
  FocusNode addressNode = FocusNode();
  FocusNode lastNameNode = FocusNode();
  FocusNode emailNode = FocusNode();
  FocusNode passwordNode = FocusNode();
  FocusNode sPhoneNode = FocusNode();
  ...
  signUp() async {
    ...
    var body = {
      ...
      "driverAttributes": {
        ...
        if (viewModel.documents[3]["file"].path != "")"insuranceDocument": insuranceDocument.data,
        "certifiedCopy": certifiedCopy.data,
        "veichleImage": veichleImage.data,
        "addressProof": addressProof.data
      }
    };
    ApiResponse apiResponse  = await viewModel.signUpAccount(request: RequestBody(body: body));
    // Get.back();
