...
Widget buildAddImage(var data,Function()? onTap,Function()? onRemove) => Column(
      children: [
        DottedBorder(
          dashPattern: [10, 6],
          ...
          child: Container(
              width: Get.width,
              height: 100,
              padding: data["file"].path.toString().split(".").last == "pdf" ||
                      data["file"].path.toString().split(".").last == "doc" ||
