...
Widget orderItem(index,{int selectedIndex=-1}) => Container(
      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 25),
      decoration: BoxDecoration(
        color: Colors.white,
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: selectedIndex==index?const Color(0xff1B7575):const Color(0xffEAEAEA))),
      child: Column(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 2),
                    const Text(
                      "#5 Suite, Trincity Industrial Esta 123 Kula Plains suite 32890",
                      maxLines: 1,
                      style: TextStyle(
                        color: Color(0xff969696),
                        overflow: TextOverflow.ellipsis,
